This is the repository containing all my Hyprland settings. My scripts are based on my current operating system, Arch, so if something doesn't work, I'm definitely not the right person to ask for help.

Part of the documentation is currently being written, so if you find some README files, great. Otherwise, I'll be adding them shortly. The fonts used have also been added to the repository.
